...
class CategoricalDistribution(BaseDistribution):
    ...
    def sample(self, size: int) -> np.array:
        return np.random.choice(self.categories, size=size, p=self.p)  # replace with your code
...
class UniformDistribution(NumericalDistribution):
    ...
    def sample(self, size: int) -> np.array:
        return np.random.uniform(self.low, self.high, size=size)  # replace with your code
        
    def scale(self, sample: np.array) -> np.array:
        return  (sample - self.low) / (self.high - self.low) # replace with your code
...
class LogUniformDistribution(NumericalDistribution):
    ...
    def sample(self, size: int) -> np.array:
        return np.exp(np.random.uniform(self.log_low, self.log_high, size=size))  # replace with your code
        
    def scale(self, sample: np.array) -> np.array:
        return (np.log(sample) - self.log_low) / (self.log_high - self.log_low) # replace with your code
...
class IntUniformDistribution(NumericalDistribution):
    ...
    def sample(self, size: int) -> np.array:
        return np.random.choice(np.arange(self.low, self.high+1), size=size)  # replace with your code
...
class IntLogUniformDistribution(NumericalDistribution):
    ...
    def sample(self, size: int) -> np.array:
        return np.exp(np.random.uniform(self.log_low, self.log_high, size=size)).astype('int')  # replace with your code

    def scale(self, sample: np.array) -> np.array:
        return (sample - sample.min()) / (sample.max() - sample.min())  # replace with your code
